        ...
        <div className="deepml-nav-inner">
              ...
              <ul className="deepml-nav-links">
                ...
                >
                  ...
                  {learnOpen && (
                    <div className="deepml-dropdown-menu">
                      <a href="#/practice" className="deepml-dropdown-item" onClick={() => setLearnOpen(false)}>
                        <svg className="deepml-item-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                      ...
                      <a href="#/plan" className="deepml-dropdown-item" onClick={() => setLearnOpen(false)}>
                        <svg className="deepml-item-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                          <circle cx="5" cy="20" r="1.8"/><circle cx="11" cy="14" r="1.8"/><circle cx="17" cy="8" r="1.8"/><path d="M5 20h6v-6h6V8"/>
                        </svg>
                        <div>
                          <div className="deepml-item-title">Learning Path</div>
                          <div className="deepml-item-sub">14-week guided route through the fundamentals</div>
                        </div>
                      </a>
                      <a href="#/projects" className="deepml-dropdown-item" onClick={() => setLearnOpen(false)}>
                        <svg className="deepml-item-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                          <rect x="4" y="16.5" width="16" height="4" rx="1"/><rect x="6" y="10.5" width="12" height="4" rx="1"/><rect x="8" y="4.5" width="8" height="4" rx="1"/>
                        </svg>
                        <div>
                          <div className="deepml-item-title">Projects</div>
                          <div className="deepml-item-sub">Build an Eval Platform, Agent Sandbox, RLHF Lab</div>
                        </div>
                      </a>
                      <a href="#/practice" className="deepml-dropdown-item" onClick={() => setLearnOpen(false)}>
                        <svg className="deepml-item-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                        ...
                        <div>
                          ...
                          <div className="deepml-item-sub">8-dimension rubric scoring & correction loops</div>
                        </div>
                      </a>
                    </div>
                  )}
                ...
                {(Object.entries(VIEWS) as [ViewKey, (typeof VIEWS)[ViewKey]][]).map(([key, view]) => (
                  <li key={key} className="deepml-nav-item">
                    <a
                      href={`#${view.path}`}
                      className={key === active ? "app-nav-link deepml-nav-link is-active active" : "app-nav-link deepml-nav-link"}
                      aria-current={key === active ? "page" : undefined}
                    >
                      {view.label}
                      {key === active && <span className="deepml-active-bar" aria-hidden="true" />}
                    </a>
                  </li>
                ))}
                ...
                >
                  ...
                  {competeOpen && (
                    <div className="deepml-dropdown-menu" style={{ minWidth: "260px" }}>
                      <a href="#/progress" className="deepml-dropdown-item" onClick={() => setCompeteOpen(false)}>
                        <svg className="deepml-item-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                      ...
                      <a href="#/progress" className="deepml-dropdown-item" onClick={() => setCompeteOpen(false)}>
                        <svg className="deepml-item-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                          <circle cx="12" cy="8" r="4.5"/><path d="m12 5.6.9 1.7 1.9.3-1.4 1.4.3 1.9L12 10l-1.7.9.3-1.9-1.4-1.4 1.9-.3Z"/>
                        </svg>
                        <div>
          ...
          <div className="deepml-nav-right">
            ...
            <div className="sidebar__status">
              {!online ? (
                <span className="deepml-live-indicator" style={{ color: "var(--warning)", background: "var(--warning-soft)", borderColor: "rgba(245,158,11,0.3)" }}>
      ...
      <div className="deepml-subnav" role="region" aria-label="Track Status and Controls">
        <div className="deepml-subnav-inner">
          <div className="deepml-subnav-track-info">
            <span className="deepml-live-indicator" style={{ background: "transparent", border: "none", padding: 0 }}>
              <span className="deepml-pulse-dot" />
              Active Track: <strong>Curriculum Track</strong>
            </span>
            {currentWeek && (
              <span className="sidebar__week" style={{ fontFamily: "var(--font-mono)", fontSize: "0.78rem", color: "var(--text-muted)", marginLeft: "var(--space-3)" }}>
          ...
          <div className="deepml-track-tag-badge">
            ...
            >
              {showTracksBanner ? "Hide Tracks Explorer" : "✦ Company Tracks (Anthropic, OpenAI, DeepMind...)"}
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="app-column">
        {!online && (
          <p role="status" className="task-offline shell-offline">
            <span>⚠</span>
            <span>
              You are offline. Saved data remains visible, but editing is disabled until you reconnect.
            </span>
          </p>
        )}
          ...
          <div className="deepml-footer-inner">
            <div className="deepml-footer-grid">
              <div className="deepml-footer-brand">
                <h3>Deep-ML</h3>
                <p>
                  Company-specific machine learning interview preparation: paced paths,
                  resume projects, mock interviews, and readiness tracking.
                </p>
              ...
              <div className="deepml-footer-col">
                ...
                <ul className="deepml-footer-links">
                  ...
                  <li><a href="#/plan">14-Week Learning Path</a></li>
                  <li><a href="#/projects">Resume Projects</a></li>
                  <li><a href="#/practice">Coding & Mocks</a></li>
                  <li><a href="#/readiness">Readiness Matrix</a></li>
                  <li><a href="#/progress">Progress Analytics</a></li>
                  <li><a href="#/settings">Settings & Reminder</a></li>
                </ul>
              </div>
